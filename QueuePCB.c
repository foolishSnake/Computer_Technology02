...
{ 
   ...
   if (newPtr != NULL) { // is space available 
      newPtr->data.ID = value;
	  newPtr->data.processStatus = 1;
	  newPtr->data.counterValue = 6;
      newPtr->nextPtr = NULL;
...
{ 
   ...
   if (currentPtr == NULL) {
      ...
      while (currentPtr != NULL) { 
         printf("ID-%c, Process Status-%d, Counter-%d --> ", currentPtr->data.ID, currentPtr->data.processStatus, currentPtr->data.counterValue);
